package Excel_utility;
	...
	*/
	...
	(row.getCell(i).getStringCellValue().trim().equals(colName.trim()))
	...
	// if(cell.getCellType()==read_write.CELL_TYPE_STRING)
	// return cell.getStringCellValue();
	...
	(row.getCell(i).getStringCellValue().trim().equals(colName))
	...
	//
	// XSSFHyperlink link = createHelper.createHyperlink(read_write.LINK_FILE);
	// link.setAddress(url);
	...
	// return true;
	// }
	public int getCellRowNum(String sheetName, String colName, String
	cellValue) {
