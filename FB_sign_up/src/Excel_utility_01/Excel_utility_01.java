...
public class Excel_utility_01
{
	...
	String path;
	public Excel_utility_01 (String path)
	{
	this.path=path;
	}
	...
	String data;
	try{
	data = formatter.formatCellValue(cell); //Returns the formatted

	//value of a cell as a String regardless of the cell type.
	...
	workbook=new XSSFWorkbook(fi);
	if(workbook.getSheetIndex(sheetName)==-1) // If sheet not exists
